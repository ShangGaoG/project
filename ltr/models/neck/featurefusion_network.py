...
class DecoderCFALayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
        ...
        tgt2 = self.multihead_attn(self.with_pos_embed(tgt, pos_dec),
                                   self.with_pos_embed(memory, pos_enc),
...
class FeatureFusionLayer(nn.Module):
    ...
    def forward_post(self, src1, src2,
        ...
        src22 = self.multihead_attn2(self.with_pos_embed(src2, pos_src2),
                                   self.with_pos_embed(src1, pos_src1),
                                   src1, attn_mask=src1_mask,
                                   key_padding_mask=src1_key_padding_mask)[0]
        ...
        src12 = self.multihead_attn1(self.with_pos_embed(src1, pos_src1),
...
class QueryLayer(nn.Module):
    ...
    def forward_post(self, src1, src2,
        ...
        #                            value=src1, attn_mask=src1_mask,
        #                            key_padding_mask=src1_key_padding_mask)[0]
        src2 = self.multihead_attn(self.with_pos_embed(src2, pos_src2),
                                   self.with_pos_embed(src1, pos_src1),
                                   src1, attn_mask=src1_mask,
                                   key_padding_mask=src1_key_padding_mask)[0]
