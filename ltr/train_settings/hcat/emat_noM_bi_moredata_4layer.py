...
def run(settings):
    ...
    settings.description = 'emat noM bi with more data for four layer.'
    ...
    settings.exname = 'four-layer-NoM-bi-moredata'
    ...
    dataset_train = sampler.HCATSampler([got10k_train, lasot_depth_train, coco_train, depthtrack_train,], [1,1,1,1],
                                samples_per_epoch=1000*settings.batch_size, max_gap=30, processing=data_processing_train)
