...
def main():
    ...
    # run_training('hcat', 'hcat_early_noM', args.cudnn_benchmark)
    # run_training('hcat', 'emat_noM_bi_moredata_1layer', args.cudnn_benchmark)
    run_training('hcat', 'resnet50_noM_bi_moredata', args.cudnn_benchmark)
